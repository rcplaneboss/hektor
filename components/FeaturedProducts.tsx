  ...
  return (
    <section className="flex justify-center items-center py-16">
      <div className="flex flex-col justify-center items-center w-screen">
        ...
        {featuredproducts ? (
          <div className="flex items-center justify-center w-full px-44 max-md:px-20 py-12 max-sm:px-8">
            <FeaturedProductComponents data={featuredproducts} />
          </div>
        ) : (
          <div className="flex flex-col justify-center items-center py-16">
            <AlertTriangle color="blue" className="w-16 h-16" />
            <div className="text-2xl text-p4">No Featured Products are avialable now!</div>
          </div>
        )}
      </div>
    </section>
